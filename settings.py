...
#        'NAME': 'safety',                      # Or path to database file if using sqlite3.
#        'USER': 'root',                      # Not used with sqlite3.
#        'PASSWORD': 'nishu',                  # Not used with sqlite3.
...
STATIC_ROOT =''# os.path.join(PROJECT_BASE_PATH, 'static').replace('\\', '/')
...
SECRET_KEY = 'l&bkvr_somac2ei^0znd9gf8u_3y3#k89fst1m^q=b#&yu4!f_'
